...
public:
    ...
    void draw(const vector<SFootballer> &footballers, int setting, int mode, int clubNumber, bool isTraining = false, int sort = 0);
...
private:
    ...
    int getTextColor(int setting, int mode, int settingCount, bool isTraining, int sort, int color);
