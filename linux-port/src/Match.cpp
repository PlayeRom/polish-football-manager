...
bool Match::runMecz() {
    ...
    int gdzie = 1, belka = 1;
    int wiado[10], ktop[10], i = 0, los = 0, co = 0, x1 = 0, x2 = 0, x3 = 0, czyzmiana = 1, pos1 = 0, pos2 = 0, pos = 0;
    int pam; // pamieta numer zawodnika, ktorego trzeba przeniesc do nastepnych wiadomosci, np. "%s strzela!", pam = x, "%s strzelił"
    int q = 0, str[8] = {0, 0, 0, 0, 0, 0, 0, 0}, str2[8] = {0, 0, 0, 0, 0, 0, 0, 0}, dystans = 0, zmiana = 0;
    ...
    if (clubRef.isMatch && !clubRef.isNotAllowedTeamPlayer) {
        ...
        do {
            ...
            if (czyzmiana == 1) {
                czyzmiana = 0;
                k = 0;
                while (k != 16) { // <- 16 max zawodnikow razem z rezerwowymi
                    k++;
                    for (size_t index = 0; index < pFootballers->getSizePlayerTeam(); index++) {
                        SFootballer &footballer = pFootballers->getPlayerTeam(index);

                        if (footballer.data[0] == k) {
                            zastep[k - 1] = footballer.surname;
                        }
                    }

                    for (size_t index = 0; index < pFootballers->getSizeRivals(); index++) {
                        SFootballer &footballer = pFootballers->getRival(index);
                        if (footballer.data[0] == k && footballer.data[22] == clubRef.rivalData[0]) {
                            rzastep[k - 1] = footballer.surname;
                        }
                    }
                }
            }
            //-------przypisanie składu end
            pInput->clrscr();
            ...
            if (start == 1 && koniec < 3) { //mecz się rozpoczął
                ...
                if (gdzie == 1) {
                    ...
                    if (co == 1) {
                        ...
                        if (pilka == 1) {
                            ktop[1] = 2;
                            dlawiado[2] = rzastep[6];
                            dlawiado[3] = pClub->getClubName(clubRef.rivalData[0] - 1);
                            pilka = 2;
                        }
                        else {
                            ktop[1] = 1;
                            dlawiado[2] = zastep[6];
                            dlawiado[3] = pClub->getClubName(clubRef.clubId - 1);
                            pilka = 1;
                        }
                        gdzie = 1;
                    }//co=3||co=4
                        ...
                        if (pilka == 1) {
                            dlawiado[2] = rzastep[los - 1];
                            ktop[1] = 2;
                            ktop[2] = 2;
                        }
                        else {
                            dlawiado[2] = zastep[los - 1];
                            ktop[1] = 1;
                            ktop[2] = 1;
                        }
                        ...
                        if (co == 3) { //jest żółta
                            ...
                            if (pilka == 1) {
                                dlawiado[6] = rzastep[los - 1];
                                ktop[3] = 2;
                            }
                            else {
                                dlawiado[6] = zastep[los - 1];
                                ktop[3] = 1;
                            }
                        }// jest żółta end
                        ...
                        if (pilka == 1) {
                            x1 = clubRef.teamSetting;
                            dlawiado[8] = zastep[6];
                            dlawiado[10] = zastep[6];
                        }
                        else {
                            x1 = clubRef.rivalData[2];
                            dlawiado[8] = rzastep[6];
                            dlawiado[10] = rzastep[6];
                        }
                        ...
                        if (los == 0) { //na lewe skrzydło
                            ...
                            if (x1 == 1 || x1 == 2 || x1 == 3 || x1 == 4 || x1 == 10 || x1 == 11) {
                                ...
                                else dlawiado[11] = rzastep[5];
                                pam = 5;
                            }

                            if (x1 == 5 || x1 == 6 || x1 == 7 || x1 == 8 || x1 == 12 || x1 == 13 || x1 == 14) {
                                if (pilka == 1) dlawiado[11] = zastep[4];
                                else dlawiado[11] = rzastep[4];
                                pam = 4;
                            }

                            if (x1 == 9) {
                                if (pilka == 1) dlawiado[11] = zastep[7];
                                else dlawiado[11] = rzastep[7];
                                pam = 7;
                            }
                        }
                        else if (los == 1) { //podanie na prawe skrzydło
                        ...
                        los = (rand() % 3) + 2;
                        if (pilka == 1) {
                            dlawiado[4] = rzastep[los - 1];
                            pilka = 2;
                        }
                        else {
                            dlawiado[4] = zastep[los - 1];
                            pilka = 1;
                        }
                        gdzie = 1;
                        ktop[2] = pilka;
                        ...
                        dlawiado[1] = pilka == 1 ? zastep[los - 1] : rzastep[los - 1];
                    ...
                    wiado[0] = 29;
                    ktop[0] = pilka;
                    dlawiado[0] = pilka == 1 ? zastep[pam] : rzastep[pam];
                    ...
                    if (co == 10) { //udane dośrodkowanie
                        ...
                        dlawiado[3] = (pilka == 1) ? rzastep[3] : zastep[3];
                        ...
                        dlawiado[3] = pilka == 1 ? rzastep[los - 1] : zastep[los - 1];

                        wiado[2] = 33;
                        dlawiado[4] = dlawiado[3];
                        dlawiado[5] = dlawiado[2];
                        x2 = (rand() % 6);
                        if (pilka == 1) {
                            ktop[2] = 2;
                            ktop[3] = 2;
                        ...
                        ktop[4] = pilka;
                        if (pilka == 1) {
                            dlawiado[8] = zastep[los - 1];
                            str[0]++;
                        }
                        else {
                            dlawiado[8] = rzastep[los - 1];
                            str2[0]++;
                        }
                        pam = los - 1;
                        wiado[5] = 63;
                    ...
                    if (co == 14) { //spalony
                        ...
                        ktop[0] = pilka;
                        isPossibleGoToTactics = 1;
                        dlawiado[0] = pilka == 1 ? zastep[10] : rzastep[10];
                        ...
                        dlawiado[2] = pilka == 1 ? rzastep[los - 1] : zastep[los - 1];
                        ...
                        wiado[4] = x1 == 0 ? 53 : 54;
                        los = (rand() % 4) + 8;
                        dlawiado[8] = (pilka == 1) ? zastep[los - 1] : rzastep[los - 1];
                        pam = los - 1;
                        gdzie = 5;
                        ktop[4] = pilka;
                    }//karny
                        ...
                        wiado[2] = 56;
                        wiado[3] = 78;
                        dlawiado[6] = (pilka == 1) ? zastep[6] : rzastep[6];
                        gdzie = 3;
                    }//róg
                        ...
                        dlawiado[0] = (pilka == 1) ? zastep[los - 1] : rzastep[los - 1];
                        dlawiado[3] = dlawiado[0];
                        wiado[1] = 50;
                        wiado[2] = 61;
                        wiado[3] = 62;
                        ktop[3] = pilka;
                        dlawiado[6] = dlawiado[0];
                        wiado[4] = 19;
                        ktop[4] = pilka;
                        x2 = (rand() % 6);
                        if (x1 == INSTR_TREATMENT_SOFT) { //delikatne
                        ...
                        if (co == 3) { //jest żółta
                            ...
                            wiado[5] = 21;
                            dlawiado[10] = dlawiado[3];
                            ktop[5] = pilka;
                        }//słownie end
                        wiado[6] = 41;
                        if (pilka == 1) {
                            pilka = 2;
                            dlawiado[12] = rzastep[0];
                        }
                        else {
                            pilka = 1;
                            dlawiado[12] = zastep[0];
                        }
                        ktop[6] = pilka;
                        gdzie = 1;
                    }//faul napastnika
                ...
                //*********************** obron B ***********************************
                    ...
                    if (co == 24) { // udana
                        ...
                        dlawiado[0] = (pilka == 1) ? rzastep[0] : zastep[0];
                        gdzie = 3;
                    }//niepewnie
                    else if (co == 27) { //róg
                        isPossibleGoToTactics = 1;
                        ...
                        if (pilka == 1) {
                            dlawiado[0] = rzastep[0];
                            dlawiado[2] = pClub->getClubName(clubRef.clubId - 1);
                            dlawiado[4] = zastep[pam];
                            dlawiado[6] = pClub->getClubName(clubRef.rivalData[0] - 1);
                            pilka = 2;
                            playerGoals++;
                            ktop[3] = 2;
                            ktop[0] = 2;
                            str[1]++;
                            dlagol1[playerGoals - 1] = zastep[pam];
                            x1 = minuta + 2;
                            ...
                            dlawiado[0] = zastep[0];
                            dlawiado[2] = pClub->getClubName(clubRef.rivalData[0] - 1);
                            dlawiado[4] = rzastep[pam];
                            dlawiado[6] = pClub->getClubName(clubRef.clubId - 1);
                            pilka = 1;
                            rivalGoals++;
                            ktop[3] = 1;
                            ktop[0] = 1;
                            str2[1]++;
                            dlagol2[rivalGoals - 1] = rzastep[pam];
                            x1 = minuta + 2;
                            if (x1 > 45 && (koniec == 0 || koniec == 1)) {
                                x1 = 45;
                            }
                        ...
                        ktop[0] = pilka;
                        if (pilka == 1) {
                            dlawiado[0] = zastep[pam];
                            pilka = 2;
                            dlawiado[2] = rzastep[0];
                        }
                        else {
                            dlawiado[0] = rzastep[pam];
                            pilka = 1;
                            dlawiado[2] = zastep[0];
                        }
                        wiado[1] = 41;
                ...
                if (minuta == 0 && koniec == 0) { //początek meczu
                    ...
                    if (ktoZacz == 1) { //zaczyna gracz
                        dlawiado[0] = pClub->getClubName(clubRef.clubId - 1);
                        pilka = 1;
                    }
                    else { //zaczyna przeciwnik
                        dlawiado[0] = pClub->getClubName(clubRef.rivalData[0] - 1);
                        pilka = 2;
                    }
                    gdzie = 1;
                    ktop[0] = pilka;
                ...
                if (los == 0) {
                    ...
                    for (size_t index = 0; index < tmpFootballers.size(); index++) {
                        ...
                        if (footballer.data[0] == los && footballer.data[22] == clubId && footballer.data[12] < 2) {
                            ...
                            if (x1 == 0) {
                                ktop[k] = 1;
                                dlawiado[k * 2] = zastep[los - 1];
                            }
                            else {
                                ktop[k] = 2;
                                dlawiado[k * 2] = rzastep[los - 1];
                            }
                        }
                    }
                ...
                }//dla if isPossibleGoToTactics==1
                //************************************************
                if (dlazmiana > 0) { //zmiana zawodnika**************
                    ...
                    wiado[k] = 5;
                    if (dlazmiana == 1) { // zmiana gracza
                        ktop[k] = 1;
                        dlawiado[k * 2] = pClub->getClubName(clubRef.clubId - 1);
                    }
                    else { // zmiana dla rywala
                        ktop[k] = 2;
                        dlawiado[k * 2] = pClub->getClubName(clubRef.rivalData[0] - 1);
                        wiado[k + 1] = 7;
                        ktop[k + 1] = 2;
                ...
                for (i = 0; i < 10; i++) {
                    ...
                    for (int index = 0; index < matchMsgs.size(); index++) {
                        ...
                        if (wiado[i] == meczs.num) {
                            ...
                            int bkgcolor = ktop[i] == 1 ? BLUE : RED;

                            pColors->textcolor(color);
                            pColors->textbackground(bkgcolor);

                            wprintf(meczs.message, dlawiado[k].c_str(), dlawiado[k + 1].c_str());

                            saveMatchMessageToFile(bkgcolor, minuta, meczs.message, dlawiado[k], dlawiado[k + 1]);
                    ...
                    if (wiado[i] != 0) { //&&wiado[i+1]!=0)
                        /*if (clubRef.isMatchAutoMsg) {
                            ...
                            while (t.tm_sec != k) {
                                ...
                                if (kbhit() && isPossibleGoToTactics == 1) {
                                    isOpenTacticsMenu = 1; // wcisnieto klawisz, i mozna wejsc w taktykę, wtedy isOpenTacticsMenu = 1
                                }
                            }
                        }
                        else {*/
                        ...
                        if (clubRef.isMatchAutoMsg) {
                            if (isPossibleGoToTactics == 1 && (key == 'A' || key == 'P')) {
                                isOpenTacticsMenu = 1; // user chce wejsc w taktyke swoja albo rywala
                            }
                        }
                        /*}*/
                    }
            ...
            if (!clubRef.isMatchAutoMsg) {
                wprintf(
                    L"S Kontynuuj    A Taktyka - %ls    P Taktyka - %ls\n\r",
                    pClub->getClubName(clubRef.clubId - 1).c_str(),
                    pClub->getClubName(clubRef.rivalData[0] - 1).c_str()
                );
            }
            ...
            switch (menu) {
                ...
                case 'A': { // taktyka gracza
                    ...
                    do {
                        ...
                        //takty(clubRef.teamSetting, 0, tak);
                        ...
                        switch (menuTeamSetting) {
                            case 'U': { // ustawienie
                                k = 0;
                                while (!k) {
                                    const wstring *settings = tactic.getTeamSettings();
                                    pInput->clrscr();
                                    pColors->textbackground(BLACK);
                                    pColors->textcolor(LIGHTRED);
                            ...
                            case 'P': {
                                ...
                                pInput->getNumbersExchange(k, i);

                                for (size_t index = 0; index < pFootballers->getSizePlayerTeam(); index++) {
                                    SFootballer &footballer = pFootballers->getPlayerTeam(index);
                                    if ((footballer.data[0] == k && footballer.data[12] > 1) ||
                                        (footballer.data[0] == i && footballer.data[12] > 1) ||
                                        (footballer.data[0] == k && footballer.data[13] > 1) ||
                                        (footballer.data[0] == i && footballer.data[13] > 1) ||
                                        (footballer.data[0] == k && footballer.data[15] > 7) ||
                                        (footballer.data[0] == i && footballer.data[15] > 5) ||
                                        (footballer.data[0] == k && footballer.data[14] == 1) ||
                                        (footballer.data[0] == i && footballer.data[14] == 1)
                                    ) {
                                        k = 1; // uniemozliwia zmiane
                                        i = 1;
                                    }
                                }

                                if (k < 1 || k > 16 || i < 1 || i > 16 || zmiana >= 3) {
                                    k = 1; // uniemozliwia zmiane
                                    i = 1;
                                }
                                ...
                                if (k != i) {
                                    if ((k < 12 && i > 11) || (i < 12 && k > 11)) {
                                        ...
                                        dlazmiana = 1;
                                        wiado[9] = 6;
                                        if (k <= 11 && i > 11) { // stalenie w wiadomosci kto kogo zastepuje
                                            dlawiado[18] = zastep[i - 1];
                                            dlawiado[19] = zastep[k - 1];
                                        }
                                        else { //if (i <= 11 && k > 11) {
                                            dlawiado[18] = zastep[k - 1];
                                            dlawiado[19] = zastep[i - 1];
                                        }
                                    }
                ...
                case 'P': { // taktyka przeciwnika
                    ...
                    do {
                        ...
                        tactic.drawTeamSetting(clubRef.rivalData[2], false);
        ...
        return true;
    }//dla clubRef.isMatch==1
    else { //if (clubRef.isMatch==0)lub clubRef.isNotAllowedTeamPlayer==1
        pInput->clrscr();
        pColors->textcolor(LIGHTRED);
...
void Match::saveMatchMessageToFile(int bkgcolor, int minuta, const wstring message, const wstring param1, wstring param2)
{
    SLastMatch lastMatch;
    lastMatch.textcolor = bkgcolor == BLUE ? LIGHTBLUE : RED;

    wchar_t timeBuffer[16];
    wchar_t msgBuffer[MAX_NEWS_LENGTH];

    swprintf(timeBuffer, 16, L"%02d min.", minuta + 2);
    swprintf(msgBuffer, MAX_NEWS_LENGTH, message.c_str(), param1.c_str(), param2.c_str());

    swprintf(lastMatch.text, MAX_NEWS_LENGTH, L"%ls %ls", timeBuffer, msgBuffer);
